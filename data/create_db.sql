...
CREATE TABLE "list" (
  ...
  /*
    GENERATED ALWAYS : Notre SGBD va toujours générer une valeur
    GENERATED BY DEFAULT : Notre SGBD va générer par défaut une valeur, mais on encore l'opportunité de lui fournir une valeur manuellement
  */
